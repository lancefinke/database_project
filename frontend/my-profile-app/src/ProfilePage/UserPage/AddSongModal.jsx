...
const AddSongModal = ({ albums, isOpen, onClose, onSubmit }) => {
  ...
  const uploadSong = async() => {
    ...
    const url = `https://localhost:7152/api/database/UploadSong?songName=${encodedSongName}&authorID=${currentUserId}&albumID=${selectedAlbum}&genreCode=${selectedGenres}`;
